    ...
    <div className="app">
      ...
      <header className="header">
        <div className="header-content">
          ...
          <a href="https://apps.apple.com/us/app/clean-sweep-ai-device-manager/id6757876893" target="_blank" rel="noopener noreferrer" className="download-btn">Download Free</a>
        ...
        <div className="hero-content">
          <div className="hero-text">
            ...
            <div className="hero-cta fade-in-up delay-3">
              <a href="https://apps.apple.com/us/app/clean-sweep-ai-device-manager/id6757876893" target="_blank" rel="noopener noreferrer" className="cta-primary">
      ...
      <footer className="footer">
        <div className="footer-content">
          ...
          <div className="footer-links">
            ...
            <a href="https://www.apple.com/legal/internet-services/itunes/dev/stdeula/" target="_blank" rel="noopener noreferrer">Terms of Service</a>
          </div>
        </div>
